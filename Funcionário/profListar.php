        ...
        <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
            ...
            <div class="w3-code cssHigh notranslate">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM medfarma.medicamento";
                ...
                ?>
                            ...
                            <a href='profAtualizar.php?id=<?php echo $cod; ?>'><img src='imagens/Edit.png' title='Editar Medicamento' width='32'></a>
                            </td><td>
                            <a href='profExcluir.php?id=<?php echo $cod; ?>'><img src='imagens/Delete.png' title='Excluir Medicamento' width='32'></a>
                            </td>
                            </tr>
                <?php
                            }
