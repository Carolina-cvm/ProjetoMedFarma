...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <h1 class="w3-xxlarge">Exclusão Dos Medicamentos </h1>
            ...
            <div class="w3-code cssHigh notranslate">
				...
				?>
								<div class="w3-container w3-theme">
									 <center><h2>Exclusão dos Medicamentos</h2></center>
								</div>
								<form class="w3-container" action="ProfExcluir_exe.php" method="post" onsubmit="return check(this.form)">
									...
									<p>
									<label class="w3-text-deep-purple"><b>Valor: </b><?php echo $row['Valor']; ?></label></p>
									<p>
									<p>
									<label class="w3-text-deep-purple"><b>Endereço: </b><?php echo $row['Endereco']; ?></label></p>
									<p>
									<p>
									<label class="w3-text-deep-purple"><b>Quantidade: </b><?php echo $row['Quantidade']; ?></label></p>
									<p>
