...
---------------------------------------------------------------------------------->
	...
	<body  onload="w3_show_nav('menuProf')">
		...
		<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
			...
			<center>
				<h1 class="w3-jumbo">MedFarma</h1></center>
				<center><p class="w3-xlarge">Sua saúde e economia em 1° lugar </p></center>
                <div class="Teste">
				<center>
				    <img src="imagens/1.jpg" class="w3-circle">

				    <img src="imagens/qwe.jpg" class="w3-circle">
				
				    <img src="imagens/2.jpg" class="w3-circle"> </center>
