...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        ...
        <div class="w3-code cssHigh notranslate">
            ...
            $sql = "SELECT * FROM ofertamedicamento";
            ...
            if ($result = mysqli_query($conn, $sql)) {
				...
				?>
                        <a href='discAtualizar.php?id=<?php echo $cod; ?>'><img src='imagens/Edit.png' title='Editar Ofertas' width='32'></a>
                        </td><td>
                        <a href='discExcluir.php?id=<?php echo $cod; ?>'><img src='imagens/Delete.png' title='Excluir Oferta' width='32'></a>
                        </td>
                        </tr>
				 <?php
                    }
