...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        <h1 class="w3-xxlarge">Realizando Compra </h1>
        ...
        <p class="w3-large">
            <div class="w3-code cssHigh notranslate">
				...
				$sql = "SELECT idMedicamento, Nome, Gramagem,Valor,Endereco FROM medicamento WHERE idMedicamento = $id";
				...
				?>
								<div class="w3-container w3-theme">
									 <center><h2>Realizando Compra</h2></center>
								</div>
								<form class="w3-container" action="compra_exe.php" method="post" onsubmit="return check(this.form)">
									...
									<p>
									<label class="w3-text-deep-purple"><b>Gramagem: </b><?php echo $row['Gramagem']; ?></label></p>
									...
									<input type="submit" value="Confirma Pedido?" class="w3-btn w3-red" >
