...
<div class="w3-main w3-container" style="margin-left:270px;margin-top:117px;">
    ...
    <div class="w3-panel w3-padding-large w3-card-4 w3-light-grey">
        ...
        <form method="POST" action="pesquisarOfertas.php">
            ...
            <input type="text" class="css-input" name="pesquisar" placeholder="Pesquisar Ofertas">
        ...
        <div class="w3-code cssHigh notranslate">
            ...
            if ($result = mysqli_query($conn, $sql)) {
				...
				?>
                        <a href='qr-code.php?id=<?php echo $cod; ?>'><img src='imagens/png.png' title='Pegar QR-Code' width='32'></a>
